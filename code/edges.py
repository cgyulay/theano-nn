#NB this is sample convnet code taken from http://deeplearning.net/tutorial/lenet.html
...
img_tensor = img.transpose(2, 0, 1).reshape(1, 3, 276, 460)
filtered_img = f(img_tensor)
